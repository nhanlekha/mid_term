...
class _ChatPageState extends State<ChatPage> {
  ...
  void didChangeDependencies() {
    ...
    userModel = UserService.userMod;
    if (userModel != null) {
      // Safe to access userModel properties
  ...
  Widget build(BuildContext context) {
    return AppBarContainer(
      appBar: AppBar(
        ...
        actions: [
          ImageHelper.loadFromAsset("assets/images/video_add.png", width: 30),
          const SizedBox(
            width: 15,
          ),
          ImageHelper.loadFromAsset("assets/images/message_add.png", width: 30),
          const SizedBox(
            width: 15,
          ),
        ],
